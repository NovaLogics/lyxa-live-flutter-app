...
class Logger {
  ...
  // Specific log levels
  static void logDebug(String message, {String tag = "Logger"}) {
    log(message, tag: tag, level: "DEBUG");
  }

  static void logInfo(String message, {String tag = "Logger"}) {
    log(message, tag: tag, level: "INFO");
  }

  static void logWarning(String message, {String tag = "Logger"}) {
    log(message, tag: tag, level: "WARNING");
  }

  static void logError(String message, {String tag = "Logger"}) {
